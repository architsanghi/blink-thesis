    ...
    apply
    {
        ...
        else
        {
            ...
            if (custom_metadata.use_blink == 1w1)
            {
                ...
                if (custom_metadata.selected == 1w1 && rerouting_ts_tmp > 0 && (custom_metadata.ingress_timestamp_millisecond -rerouting_ts_tmp) < ((bit<19>)TIMEOUT_PROGRESSION))
                {
                    ...
                    if (custom_metadata.flowselector_cellid < (FLOWSELECTOR_NBFLOWS >> 1))
                    {
                        ...
                        if (nh_avaibility_2_tmp == 1w0)
                        {
                            ...
                            {
                                flowselector_fwloops.read(flowselector_fwloops_tmp,(FLOWSELECTOR_NBFLOWS * custom_metadata.id) + custom_metadata.flowselector_cellid);
                                ...
                                {
                                    flowselector_fwloops.write((FLOWSELECTOR_NBFLOWS * custom_metadata.id) + custom_metadata.flowselector_cellid, flowselector_fwloops_tmp + 1);
                                }
                            }
                        }
                        else
                ...
                if (rerouting_ts_tmp > 0 && (custom_metadata.ingress_timestamp_millisecond - rerouting_ts_tmp) > ((bit<19>)TIMEOUT_PROGRESSION))
                {
