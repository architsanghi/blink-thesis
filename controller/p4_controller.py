        ...
        for host in list(self.topo.get_hosts()):
            ...
            for id_prefix in [self.mapping_dic[host]*2, self.mapping_dic[host]*2+1]:
                ...
                with HiddenPrints():
                    ...
                    # myfile.write("checking\n")
                    # myfile.write(str(nbflows_progressing_2))
                    # myfile.write("\n")
            ...
            for id_prefix in [self.mapping_dic[host]*2, self.mapping_dic[host]*2+1]:
                ...
                for i in range(0, 64):
                    with HiddenPrints():
                        ...
                        # myfile.write("going3\n")
                        # myans= self.controller.register_read('my_reg',0);
                        # myfile.write(str(myans))
                        # myfile.write("\n")
                ...
                # for i in range(0,47):
                # 	with HiddenPrints():
                # 		myans= self.controller.register_read('my_reg',i);
	               #  	myfile.write("archit\n")
	               #  	myfile.write(str(i))
	               #  	myfile.write("-->")
	               #  	myfile.write(str(myans))
